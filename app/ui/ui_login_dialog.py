...
"")
        ...
        self.keyboardLayoutContainer = QtWidgets.QWidget(parent=LoginDialog)
        self.keyboardLayoutContainer.setMinimumSize(QtCore.QSize(150, 120))
        self.keyboardLayoutContainer.setStyleSheet("background: transparent;")
        self.keyboardLayoutContainer.setObjectName("keyboardLayoutContainer")
        self.verticalLayoutWidget = QtWidgets.QWidget(parent=self.keyboardLayoutContainer)
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(9, 9, 141, 111))
        self.verticalLayoutWidget.setObjectName("verticalLayoutWidget")
        self.keyboardLayout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
