...
2.  Додаток захопить весь інтерфейс програми
    (без системних панелей Windows/Linux).
...
2.  Відкриється стандартне вікно вибору файлу
    , автоматично спрямоване у папку `media/`.
