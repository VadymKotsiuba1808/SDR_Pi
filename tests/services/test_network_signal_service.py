...
def test_os_branch_selection_windows(signal_service):
    """Перевіряємо, що на Windows обирається правильна гілка."""
...
def test_os_branch_selection_linux(signal_service):
    """Перевіряємо, що на Linux обирається правильна гілка."""
...
def test_get_windows_wifi_signal_parsing(signal_service):
    """Тест парсингу netsh. Запускається ТІЛЬКИ на Windows."""
...
def test_get_linux_wifi_signal_nmcli_parsing(signal_service):
    """Тест парсингу nmcli. Запускається ТІЛЬКИ на Linux/Unix."""
...
def test_get_signal_strength_flow(signal_service):
    """Загальна логіка пріоритетів (WiFi > Wired)."""
